...
list.of.packages <- c("xtable", "ggplot2", "pROC", "RColorBrewer", "corrplot", 
                      ...
                      "SnowballC", "tidyverse", "tsne", "psych")
...
```{r random forest consult_dart all structured}
...
```{r random forest for consult_dart train}
...
table(atrain$consult_dart_dg)

table(x$consult_dart_dg, useNA = c("ifany"))
